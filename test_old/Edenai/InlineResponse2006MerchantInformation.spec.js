...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006MerchantInformation', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2006MerchantInformation();
      });

      it('should create an instance of InlineResponse2006MerchantInformation', function() {
        // TODO: update the code to test InlineResponse2006MerchantInformation
        expect(instance).to.be.a(Edenai.InlineResponse2006MerchantInformation);
      });

      it('should have the property merchantAddress (base name: "merchant_address")', function() {
