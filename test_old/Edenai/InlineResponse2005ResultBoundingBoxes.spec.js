...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2005ResultBoundingBoxes', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2005ResultBoundingBoxes();
      });

      it('should create an instance of InlineResponse2005ResultBoundingBoxes', function() {
        // TODO: update the code to test InlineResponse2005ResultBoundingBoxes
        expect(instance).to.be.a(Edenai.InlineResponse2005ResultBoundingBoxes);
      });
