...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2002Cells', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2002Cells();
      });

      it('should create an instance of InlineResponse2002Cells', function() {
        // TODO: update the code to test InlineResponse2002Cells
        expect(instance).to.be.a(Edenai.InlineResponse2002Cells);
      });
      ...
      it('should have the property rowSpan (base name: "row_span")', function() {
        // TODO: update the code to test the property rowSpan
        expect(instance).to.have.property('rowSpan');
        // expect(instance.rowSpan).to.be(expectedValueLiteral);
      });

      it('should have the property colSpan (base name: "col_span")', function() {
        // TODO: update the code to test the property colSpan
        expect(instance).to.have.property('colSpan');
        // expect(instance.colSpan).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property boundingBox (base name: "bounding_box")', function() {
