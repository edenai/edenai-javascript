...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006ItemLines', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2006ItemLines();
      });

      it('should create an instance of InlineResponse2006ItemLines', function() {
        // TODO: update the code to test InlineResponse2006ItemLines
        expect(instance).to.be.a(Edenai.InlineResponse2006ItemLines);
      });
