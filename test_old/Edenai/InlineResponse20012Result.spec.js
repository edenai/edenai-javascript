...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20012Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse20012Result();
      });

      it('should create an instance of InlineResponse20012Result', function() {
        // TODO: update the code to test InlineResponse20012Result
        expect(instance).to.be.a(Edenai.InlineResponse20012Result);
      });
      ...
      it('should have the property importances (base name: "importances")', function() {
        // TODO: update the code to test the property importances
        expect(instance).to.have.property('importances');
        // expect(instance.importances).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property lemmas (base name: "lemmas")', function() {
        // TODO: update the code to test the property lemmas
        expect(instance).to.have.property('lemmas');
        // expect(instance.lemmas).to.be(expectedValueLiteral);
      });
