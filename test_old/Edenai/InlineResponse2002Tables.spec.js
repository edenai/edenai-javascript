...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2002Tables', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2002Tables();
      });

      it('should create an instance of InlineResponse2002Tables', function() {
        // TODO: update the code to test InlineResponse2002Tables
        expect(instance).to.be.a(Edenai.InlineResponse2002Tables);
      });
