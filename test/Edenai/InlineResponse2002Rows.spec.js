...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2002Rows', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2002Rows();
      });

      it('should create an instance of InlineResponse2002Rows', function() {
        // TODO: update the code to test InlineResponse2002Rows
        expect(instance).to.be.a(Edenai.InlineResponse2002Rows);
      });

      it('should have the property isHeader (base name: "is_header")', function() {
        // TODO: update the code to test the property isHeader
        expect(instance).to.have.property('isHeader');
        // expect(instance.isHeader).to.be(expectedValueLiteral);
      });
