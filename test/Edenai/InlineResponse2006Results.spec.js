...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006Results', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2006Results();
      });

      it('should create an instance of InlineResponse2006Results', function() {
        // TODO: update the code to test InlineResponse2006Results
        expect(instance).to.be.a(Edenai.InlineResponse2006Results);
      });

      it('should have the property wordText (base name: "word_text")', function() {
        // TODO: update the code to test the property wordText
        expect(instance).to.have.property('wordText');
        // expect(instance.wordText).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property hight (base name: "hight")', function() {
        // TODO: update the code to test the property hight
        expect(instance).to.have.property('hight');
        // expect(instance.hight).to.be(expectedValueLiteral);
      });

      it('should have the property customerInformation (base name: "customer_information")', function() {
        // TODO: update the code to test the property customerInformation
        expect(instance).to.have.property('customerInformation');
        // expect(instance.customerInformation).to.be(expectedValueLiteral);
      });

      it('should have the property merchantInformation (base name: "merchant_information")', function() {
        // TODO: update the code to test the property merchantInformation
        expect(instance).to.have.property('merchantInformation');
        // expect(instance.merchantInformation).to.be(expectedValueLiteral);
      });

      it('should have the property invoiceTotal (base name: "invoice_total")', function() {
      ...
      it('should have the property itemLines (base name: "item_lines")', function() {
        // TODO: update the code to test the property itemLines
        expect(instance).to.have.property('itemLines');
        // expect(instance.itemLines).to.be(expectedValueLiteral);
      });
