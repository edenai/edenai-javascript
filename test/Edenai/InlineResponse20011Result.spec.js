  ...
  describe('(package)', function() {
    describe('InlineResponse20011Result', function() {
      ...
      it('should have the property sentiments (base name: "sentiments")', function() {
        // TODO: update the code to test the property sentiments
        expect(instance).to.have.property('sentiments');
        // expect(instance.sentiments).to.be(expectedValueLiteral);
      });

      it('should have the property sentimentRate (base name: "sentiment_rate")', function() {
        // TODO: update the code to test the property sentimentRate
        expect(instance).to.have.property('sentimentRate');
        // expect(instance.sentimentRate).to.be(expectedValueLiteral);
      });
