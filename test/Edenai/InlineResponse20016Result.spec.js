...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20016Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse20016Result();
      });

      it('should create an instance of InlineResponse20016Result', function() {
        // TODO: update the code to test InlineResponse20016Result
        expect(instance).to.be.a(Edenai.InlineResponse20016Result);
      });
      ...
      it('should have the property likelihood (base name: "likelihood")', function() {
        // TODO: update the code to test the property likelihood
        expect(instance).to.have.property('likelihood');
        // expect(instance.likelihood).to.be(expectedValueLiteral);
      });
