...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2002Pages', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2002Pages();
      });

      it('should create an instance of InlineResponse2002Pages', function() {
        // TODO: update the code to test InlineResponse2002Pages
        expect(instance).to.be.a(Edenai.InlineResponse2002Pages);
      });
