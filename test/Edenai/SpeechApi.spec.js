    ...
    describe('SpeechApi', function() {
      describe('asyncSpeechToText', function() {
        it('should call asyncSpeechToText successfully', function(done) {
          ...
          opts.vocab = "vocab_example";

          instance.asyncSpeechToText(language, files, providers, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('speechToText', function() {
        it('should call speechToText successfully', function(done) {
          ...
          instance.speechToText(language, files, providers, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse201);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse201Result1);
                expect(data.solutionName).to.be.a('string');
                expect(data.solutionName).to.be("");
                ...
                expect(data.result).to.be.a(Edenai.InlineResponse201Result);
                      expect(data.result.transcribe).to.be.a('string');
                  expect(data.result.transcribe).to.be("");
                  expect(data.result.confidence).to.be.a('number');
                  expect(data.result.confidence).to.be();
      ...
      describe('textToSpeech', function() {
        it('should call textToSpeech successfully', function(done) {
          ...
          instance.textToSpeech(text, language, option, providers, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse2011);
            {
              let dataCtr = data.result;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse2011Result1);
                expect(data.solutionName).to.be.a('string');
                expect(data.solutionName).to.be("");
                expect(data.provider).to.be.a('string');
                expect(data.provider).to.be("");
