...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2004Results', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2004Results();
      });

      it('should create an instance of InlineResponse2004Results', function() {
        // TODO: update the code to test InlineResponse2004Results
        expect(instance).to.be.a(Edenai.InlineResponse2004Results);
      });
      ...
      it('should have the property transcript (base name: "transcript")', function() {
        // TODO: update the code to test the property transcript
        expect(instance).to.have.property('transcript');
        // expect(instance.transcript).to.be(expectedValueLiteral);
      });
