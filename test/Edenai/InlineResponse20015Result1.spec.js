...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20015Result1', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse20015Result1();
      });

      it('should create an instance of InlineResponse20015Result1', function() {
        // TODO: update the code to test InlineResponse20015Result1
        expect(instance).to.be.a(Edenai.InlineResponse20015Result1);
      });

      it('should have the property solutionName (base name: "solution_name")', function() {
        // TODO: update the code to test the property solutionName
        expect(instance).to.have.property('solutionName');
        // expect(instance.solutionName).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property executionTime (base name: "execution_time")', function() {
        // TODO: update the code to test the property executionTime
        expect(instance).to.have.property('executionTime');
        // expect(instance.executionTime).to.be(expectedValueLiteral);
      });

      it('should have the property originalResult (base name: "original_result")', function() {
        // TODO: update the code to test the property originalResult
        expect(instance).to.have.property('originalResult');
        // expect(instance.originalResult).to.be(expectedValueLiteral);
      });
