...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse204Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse204Result();
      });

      it('should create an instance of InlineResponse204Result', function() {
        // TODO: update the code to test InlineResponse204Result
        expect(instance).to.be.a(Edenai.InlineResponse204Result);
      });
