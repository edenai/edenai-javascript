  ...
  describe('(package)', function() {
    describe('InlineResponse2005Result', function() {
      ...
      it('should have the property boundingBoxes (base name: "bounding_boxes")', function() {
        // TODO: update the code to test the property boundingBoxes
        expect(instance).to.have.property('boundingBoxes');
        // expect(instance.boundingBoxes).to.be(expectedValueLiteral);
      });
