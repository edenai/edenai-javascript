...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006CustomerInformation', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2006CustomerInformation();
      });

      it('should create an instance of InlineResponse2006CustomerInformation', function() {
        // TODO: update the code to test InlineResponse2006CustomerInformation
        expect(instance).to.be.a(Edenai.InlineResponse2006CustomerInformation);
      });

      it('should have the property customerAddress (base name: "customer_address")', function() {
        // TODO: update the code to test the property customerAddress
        expect(instance).to.have.property('customerAddress');
        // expect(instance.customerAddress).to.be(expectedValueLiteral);
      });
