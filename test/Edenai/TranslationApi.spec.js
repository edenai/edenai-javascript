...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Edenai.TranslationApi();
  });
    ...
    describe('TranslationApi', function() {
      describe('automaticTranslation', function() {
        it('should call automaticTranslation successfully', function(done) {
          ...
          var sourceLanguage = "sourceLanguage_example";
          var targetLanguage = "targetLanguage_example";
          var providers = "providers_example";

          instance.automaticTranslation(text, sourceLanguage, targetLanguage, providers, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse20014);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse20014Result1);
                ...
                expect(data.result).to.be.a(Edenai.InlineResponse20014Result);
                      expect(data.result.sourceLanguage).to.be.a('string');
                  expect(data.result.sourceLanguage).to.be("");
                  expect(data.result.targetLanguage).to.be.a('string');
                  expect(data.result.targetLanguage).to.be("");
                  expect(data.result.translatedText).to.be.a('string');
                  expect(data.result.translatedText).to.be("");
      ...
      describe('languageDetection', function() {
        it('should call languageDetection successfully', function(done) {
          ...
          instance.languageDetection(text, providers, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse20015);
            {
              let dataCtr = data.result;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse20015Result1);
                expect(data.solutionName).to.be.a('string');
                expect(data.solutionName).to.be("");
                expect(data.provider).to.be.a('string');
                expect(data.provider).to.be("");
                ...
                expect(data.originalResult).to.be.a(Object);
                expect(data.originalResult).to.be();
                expect(data.result).to.be.a(Edenai.InlineResponse20015Result);
