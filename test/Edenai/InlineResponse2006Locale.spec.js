...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006Locale', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2006Locale();
      });

      it('should create an instance of InlineResponse2006Locale', function() {
        // TODO: update the code to test InlineResponse2006Locale
        expect(instance).to.be.a(Edenai.InlineResponse2006Locale);
      });
