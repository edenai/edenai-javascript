...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2011Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse2011Result();
      });

      it('should create an instance of InlineResponse2011Result', function() {
        // TODO: update the code to test InlineResponse2011Result
        expect(instance).to.be.a(Edenai.InlineResponse2011Result);
      });
      ...
      it('should have the property audioPath (base name: "audio_path")', function() {
        // TODO: update the code to test the property audioPath
        expect(instance).to.have.property('audioPath');
        // expect(instance.audioPath).to.be(expectedValueLiteral);
      });

      it('should have the property voiceType (base name: "voice_type")', function() {
        // TODO: update the code to test the property voiceType
        expect(instance).to.have.property('voiceType');
        // expect(instance.voiceType).to.be(expectedValueLiteral);
      });
