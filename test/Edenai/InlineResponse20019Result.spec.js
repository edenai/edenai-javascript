...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20019Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse20019Result();
      });

      it('should create an instance of InlineResponse20019Result', function() {
        // TODO: update the code to test InlineResponse20019Result
        expect(instance).to.be.a(Edenai.InlineResponse20019Result);
      });
