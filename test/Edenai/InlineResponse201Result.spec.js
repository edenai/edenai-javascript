...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse201Result', function() {
      beforeEach(function() {
        instance = new Edenai.InlineResponse201Result();
      });

      it('should create an instance of InlineResponse201Result', function() {
        // TODO: update the code to test InlineResponse201Result
        expect(instance).to.be.a(Edenai.InlineResponse201Result);
      });
