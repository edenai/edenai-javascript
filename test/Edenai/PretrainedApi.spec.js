...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Edenai.PretrainedApi();
  });

  describe('(package)', function() {
    describe('PretrainedApi', function() {
      describe('pretrainedAsyncOcrTablesWebhookCreate', function() {
        it('should call pretrainedAsyncOcrTablesWebhookCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for pretrainedAsyncOcrTablesWebhookCreate call
          /*
          var provider = "provider_example";

          instance.pretrainedAsyncOcrTablesWebhookCreate(provider, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('pretrainedAudioSpeechRecognitionAsyncList', function() {
        it('should call pretrainedAudioSpeechRecognitionAsyncList successfully', function(done) {
          // TODO: uncomment pretrainedAudioSpeechRecognitionAsyncList call
          /*

          instance.pretrainedAudioSpeechRecognitionAsyncList(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
