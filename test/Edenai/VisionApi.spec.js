      ...
      describe('explicitContentDetection', function() {
        it('should call explicitContentDetection successfully', function(done) {
          ...
          instance.explicitContentDetection(files, providers, function(error, data, response) {
            ...
            expect(data).to.be.a(Edenai.InlineResponse20016);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse20016Result1);
                ...
                expect(data.result).to.be.a(Edenai.InlineResponse20016Result);
                      expect(data.result.imagePath).to.be.a('string');
                  expect(data.result.imagePath).to.be("");
                  {
      ...
      describe('faceDetection', function() {
        it('should call faceDetection successfully', function(done) {
          ...
          instance.faceDetection(files, providers, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse20017);
            {
              let dataCtr = data.result;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse20017Result1);
                expect(data.solutionName).to.be.a('string');
                expect(data.solutionName).to.be("");
                expect(data.provider).to.be.a('string');
                expect(data.provider).to.be("");
                ...
                expect(data.originalResult).to.be.a(Object);
                expect(data.originalResult).to.be();
                expect(data.result).to.be.a(Edenai.InlineResponse20017Result);
                      expect(data.result.imagePath).to.be.a('string');
                  expect(data.result.imagePath).to.be("");
                  {
                  ...
                  expect(data.result.landmarks).to.be.a(Edenai.InlineResponse20017ResultLandmarks);
                        {
                  ...
                  expect(data.result.emotions).to.be();
                  expect(data.result.poses).to.be.a(Object);
                  expect(data.result.poses).to.be();
      ...
      describe('objectDetection', function() {
        it('should call objectDetection successfully', function(done) {
          ...
          instance.objectDetection(files, providers, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(Edenai.InlineResponse20018);
            {
              let dataCtr = data.result;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Edenai.InlineResponse20018Result1);
                expect(data.solutionName).to.be.a('string');
                expect(data.solutionName).to.be("");
                expect(data.provider).to.be.a('string');
                expect(data.provider).to.be("");
                ...
                expect(data.originalResult).to.be.a(Object);
                expect(data.originalResult).to.be();
                expect(data.result).to.be.a(Edenai.InlineResponse20018Result);
                      expect(data.result.fileName).to.be.a('string');
                  expect(data.result.fileName).to.be("");
                  {
                    let dataCtr = data.result.labels;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
