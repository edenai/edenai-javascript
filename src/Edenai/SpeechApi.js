...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse2003', 'Edenai/InlineResponse2004', 'Edenai/InlineResponse201', 'Edenai/InlineResponse2011'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../Edenai/InlineResponse2003'), require('../Edenai/InlineResponse2004'), require('../Edenai/InlineResponse201'), require('../Edenai/InlineResponse2011'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.SpeechApi = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse2003, root.Edenai.InlineResponse2004, root.Edenai.InlineResponse201, root.Edenai.InlineResponse2011);
  }
}(this, function(ApiClient, InlineResponse2003, InlineResponse2004, InlineResponse201, InlineResponse2011) {
  'use strict';

  /**
   * Speech service.
   * @module Edenai/SpeechApi
   * @version v1
   */

  /**
   * Constructs a new SpeechApi. 
   * @alias module:Edenai/SpeechApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:Edenai/SpeechApi~asyncSpeechToTextCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse2003} data The data returned by the service call.
     ...
     * @param {module:Edenai/SpeechApi~asyncSpeechToTextCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse2003}
     */
     ...
     * @callback module:Edenai/SpeechApi~asyncSpeechToText_0Callback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse2004} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} jobId 
     * @param {module:Edenai/SpeechApi~asyncSpeechToText_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse2004}
     */
     ...
     * @callback module:Edenai/SpeechApi~speechToTextCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse201} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.vocab Speechmatics allows to add a custom vocab dictionnary (json format) for better recognition, you can add it via this parameter.                     It has to be a list of dictionaries : {'content'(Required) : 'string', 'sounds_like'(Optional) : 'list of strings'}
     * @param {module:Edenai/SpeechApi~speechToTextCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse201}
     */
     ...
     * @callback module:Edenai/SpeechApi~textToSpeechCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse2011} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:Edenai/SpeechApi~textToSpeechCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse2011}
     */
