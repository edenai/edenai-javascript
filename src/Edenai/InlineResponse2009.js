...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse2009Result'], factory);
    ...
    root.Edenai.InlineResponse2009 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse2009Result);
  }
   ...
   * @module Edenai/InlineResponse2009
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse2009
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse2009} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2009} The populated <code>InlineResponse2009</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse2009Result]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:Edenai/InlineResponse2009Result>} result
   */
