...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20016Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20016Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.InlineResponse20016 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20016Result1);
  }
}(this, function(ApiClient, InlineResponse20016Result1) {
  'use strict';

  /**
   * The InlineResponse20016 model module.
   * @module Edenai/InlineResponse20016
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse20016
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse20016} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20016} The populated <code>InlineResponse20016</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20016Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:Edenai/InlineResponse20016Result1>} result
   */
