...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20010Result1'], factory);
    ...
    root.Edenai.InlineResponse20010 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20010Result1);
  }
   ...
   * @module Edenai/InlineResponse20010
   * @version v1
   */
   ...
   * search response
   * @alias module:Edenai/InlineResponse20010
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse20010} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20010} The populated <code>InlineResponse20010</code> instance.
   */
  ...
  /**
   * @member {Array.<module:Edenai/InlineResponse20010Result1>} result
   */
