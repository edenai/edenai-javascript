...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20015Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20015Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.InlineResponse20015 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20015Result1);
  }
}(this, function(ApiClient, InlineResponse20015Result1) {
  'use strict';

  /**
   * The InlineResponse20015 model module.
   * @module Edenai/InlineResponse20015
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse20015
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse20015} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20015} The populated <code>InlineResponse20015</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20015Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:Edenai/InlineResponse20015Result1>} result
   */
