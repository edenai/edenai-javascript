...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse2002BoundingBox = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2002BoundingBox model module.
   * @module Edenai/InlineResponse2002BoundingBox
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2002BoundingBox</code>.
   * @alias module:Edenai/InlineResponse2002BoundingBox
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2002BoundingBox</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse2002BoundingBox} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2002BoundingBox} The populated <code>InlineResponse2002BoundingBox</code> instance.
   */
