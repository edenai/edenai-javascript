...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse2005ResultBoundingBoxes = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2005ResultBoundingBoxes model module.
   * @module Edenai/InlineResponse2005ResultBoundingBoxes
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2005ResultBoundingBoxes</code>.
   * @alias module:Edenai/InlineResponse2005ResultBoundingBoxes
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2005ResultBoundingBoxes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse2005ResultBoundingBoxes} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2005ResultBoundingBoxes} The populated <code>InlineResponse2005ResultBoundingBoxes</code> instance.
   */
