...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20019Result'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20019Result'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.InlineResponse20019 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20019Result);
  }
}(this, function(ApiClient, InlineResponse20019Result) {
  'use strict';

  /**
   * The InlineResponse20019 model module.
   * @module Edenai/InlineResponse20019
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse20019
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse20019} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20019} The populated <code>InlineResponse20019</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20019Result]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:Edenai/InlineResponse20019Result>} result
   */
