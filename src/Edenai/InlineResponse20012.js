...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20012Result1'], factory);
    ...
    root.Edenai.InlineResponse20012 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20012Result1);
  }
   ...
   * @module Edenai/InlineResponse20012
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse20012
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse20012} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20012} The populated <code>InlineResponse20012</code> instance.
   */
  ...
  /**
   * @member {Array.<module:Edenai/InlineResponse20012Result1>} result
   */
