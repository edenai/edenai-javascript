...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse2006CustomerInformation = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2006CustomerInformation model module.
   * @module Edenai/InlineResponse2006CustomerInformation
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2006CustomerInformation</code>.
   * @alias module:Edenai/InlineResponse2006CustomerInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2006CustomerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse2006CustomerInformation} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2006CustomerInformation} The populated <code>InlineResponse2006CustomerInformation</code> instance.
   */
