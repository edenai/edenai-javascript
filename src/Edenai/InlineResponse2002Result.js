...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse2002Pages'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2002Pages'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.InlineResponse2002Result = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse2002Pages);
  }
}(this, function(ApiClient, InlineResponse2002Pages) {
  'use strict';

  /**
   * The InlineResponse2002Result model module.
   * @module Edenai/InlineResponse2002Result
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2002Result</code>.
   * @alias module:Edenai/InlineResponse2002Result
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse2002Result} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2002Result} The populated <code>InlineResponse2002Result</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pages'))
        obj.pages = ApiClient.convertToType(data['pages'], [InlineResponse2002Pages]);
    }
    return obj;
  }
  ...
  /**
   * array
   * @member {Array.<module:Edenai/InlineResponse2002Pages>} pages
   */
