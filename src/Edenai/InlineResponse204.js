...
(function(root, factory) {
   ...
   * @module Edenai/InlineResponse204
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse204</code>.
   * launch ocr tables job response
   * @alias module:Edenai/InlineResponse204
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse204} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse204} The populated <code>InlineResponse204</code> instance.
   */
