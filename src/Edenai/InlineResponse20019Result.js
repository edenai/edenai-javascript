...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse20019Result = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse20019Result model module.
   * @module Edenai/InlineResponse20019Result
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse20019Result</code>.
   * @alias module:Edenai/InlineResponse20019Result
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20019Result</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse20019Result} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20019Result} The populated <code>InlineResponse20019Result</code> instance.
   */
