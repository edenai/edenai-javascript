...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse201Result1'], factory);
    ...
    root.Edenai.InlineResponse201 = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse201Result1);
  }
   ...
   * @module Edenai/InlineResponse201
   * @version v1
   */
   ...
   * @alias module:Edenai/InlineResponse201
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse201} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse201} The populated <code>InlineResponse201</code> instance.
   */
  ...
  /**
   * @member {Array.<module:Edenai/InlineResponse201Result1>} result
   */
