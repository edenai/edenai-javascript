...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse2006Results'], factory);
    ...
    root.Edenai.InlineResponse2006Result = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse2006Results);
  }
   ...
   * @module Edenai/InlineResponse2006Result
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2006Result</code>.
   * @alias module:Edenai/InlineResponse2006Result
   * @class
   */
   ...
   * @param {module:Edenai/InlineResponse2006Result} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse2006Result} The populated <code>InlineResponse2006Result</code> instance.
   */
  ...
  /**
   * @member {Array.<module:Edenai/InlineResponse2006Results>} results
   */
