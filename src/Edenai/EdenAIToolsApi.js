...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20019'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../Edenai/InlineResponse20019'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.EdenAIToolsApi = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20019);
  }
  ...
  /**
   * EdenAITools service.
   * @module Edenai/EdenAIToolsApi
   * @version v1
   */

  /**
   * Constructs a new EdenAIToolsApi. 
   * @alias module:Edenai/EdenAIToolsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:Edenai/EdenAIToolsApi~searchCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse20019} data The data returned by the service call.
     ...
     * @param {module:Edenai/EdenAIToolsApi~searchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse20019}
     */
