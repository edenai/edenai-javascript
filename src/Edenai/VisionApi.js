...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'Edenai/InlineResponse20016', 'Edenai/InlineResponse20017', 'Edenai/InlineResponse20018'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../Edenai/InlineResponse20016'), require('../Edenai/InlineResponse20017'), require('../Edenai/InlineResponse20018'));
  } else {
    // Browser globals (root is window)
    if (!root.Edenai) {
      root.Edenai = {};
    }
    root.Edenai.VisionApi = factory(root.Edenai.ApiClient, root.Edenai.InlineResponse20016, root.Edenai.InlineResponse20017, root.Edenai.InlineResponse20018);
  }
}(this, function(ApiClient, InlineResponse20016, InlineResponse20017, InlineResponse20018) {
  'use strict';

  /**
   * Vision service.
   * @module Edenai/VisionApi
   * @version v1
   */

  /**
   * Constructs a new VisionApi. 
   * @alias module:Edenai/VisionApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:Edenai/VisionApi~explicitContentDetectionCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse20016} data The data returned by the service call.
     ...
     * @param {module:Edenai/VisionApi~explicitContentDetectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse20016}
     */
     ...
     * @callback module:Edenai/VisionApi~faceDetectionCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse20017} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} files File Image to analyse (ex: pdf, jpg, jpeg, png, tiff)
     * @param {String} providers Provider to compare (ex: [ 'amazon', 'microsoft','google'])
     * @param {module:Edenai/VisionApi~faceDetectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse20017}
     */
     ...
     * @callback module:Edenai/VisionApi~objectDetectionCallback
     * @param {String} error Error message, if any.
     * @param {module:Edenai/InlineResponse20018} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} files File Image to analyse (ex: pdf, jpg, jpeg, png, tiff)
     * @param {String} providers Provider to compare (ex: [ 'amazon', 'microsoft','google'])
     * @param {module:Edenai/VisionApi~objectDetectionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:Edenai/InlineResponse20018}
     */
