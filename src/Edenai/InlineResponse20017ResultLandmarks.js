...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse20017ResultLandmarks = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse20017ResultLandmarks model module.
   * @module Edenai/InlineResponse20017ResultLandmarks
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse20017ResultLandmarks</code>.
   * object
   * @alias module:Edenai/InlineResponse20017ResultLandmarks
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20017ResultLandmarks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse20017ResultLandmarks} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse20017ResultLandmarks} The populated <code>InlineResponse20017ResultLandmarks</code> instance.
   */
