...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Edenai.InlineResponse204Result = factory(root.Edenai.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse204Result model module.
   * @module Edenai/InlineResponse204Result
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse204Result</code>.
   * @alias module:Edenai/InlineResponse204Result
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse204Result</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:Edenai/InlineResponse204Result} obj Optional instance to populate.
   * @return {module:Edenai/InlineResponse204Result} The populated <code>InlineResponse204Result</code> instance.
   */
